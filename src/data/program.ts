...
export const PROGRAM_OPTIONS = [
  ...
  { value: "BSBA_BUS.ECO", label: "BSBA BUS.ECO - Bachelor of Science in Business Administration Major in Business Economics" },
  { value: "BSBA_FINAMGMT", label: "BSBA FINAMGMT - Bachelor of Science in Business Administration Major in Financial Management" },
  { value: "BSBA_HRMGMT", label: "BSBA HRMGMT - Bachelor of Science in Business Administration Major in Human Resource Management " },
  { value: "BSBA_MKTGMGMT", label: "BSBA MKTGMGMT - Bachelor of Science in Business Administration Major in Marketing Management" },
  { value: "BSBA_OPMGMT", label: "BSBA OPMGMT - Bachelor of Science in Business Administration Major in Operations Management" },
  ...
  { value: "BSED_ENGLISH", label: "BSED ENGLISH - Bachelor of Secondary Education Major in English " },
  { value: "BSED_FILIPINO", label: "BSED FILIPINO - Bachelor of Secondary Education Major in Filipino" },
  { value: "BSED_MATH", label: "BSED MATH - Bachelor of Secondary Education Major in Mathematics" },
  { value: "BSED_SCIENCE", label: "BSED SCIENCE - Bachelor of Secondary Education Major in Science" },
  ...
  { value: "BSLM-GBM", label: "BSLM-GBM - Bachelor of Science in Legal Management major in General Business Management" },
  { value: "BSLM-LAW", label: "BSLM-LAW - Bachelor of Science in Legal Management Major in Law" },
